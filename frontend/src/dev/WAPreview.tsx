...
const messages = [
  ...
  { id: 7, conversationId: 1, direction: "out", kind: "interactive", body: "Lütfen bir konu seçin.\n1. Teknik Destek\n2. Satış Ekibi\n3. Muhasebe Birimi", payload: { type: "interactive", interactive: { type: "button", body: { text: "Lütfen bir konu seçin." }, action: { buttons: [{ reply: { title: "Teknik Destek" } }, { reply: { title: "Satış Ekibi" } }, { reply: { title: "Muhasebe Birimi" } }] } } }, status: "read", sender: { kind: "bot", label: "yardimci" }, createdAt: ago(2) },
  { id: 8, conversationId: 1, direction: "in", kind: "interactive", body: "Teknik Destek", replyTo: { id: 7, kind: "interactive", body: "Lütfen bir konu seçin.", sender: "Chatbot" }, status: "received", sender: { kind: "customer", name: "Zeynep Arslan" }, createdAt: ago(2) },
  { id: 6, conversationId: 1, direction: "out", kind: "template", body: "Merhaba,\n\nÖrnek Şirket Teknik Destek'ten Toprak ben. Sizinle telefon üzerinden iletişime geçmeye çalıştık ancak ulaşamadık.\n\nUygun olduğunuzda bu mesaj üzerinden bizimle iletişime geçmenizi rica ederiz.\n[İletişim](tel:+908502551234)\n[Talebimi görüntüle](https://ornek.com/t/42)", status: "read", sender: { kind: "agent", userId: 1, name: "Toprak Şahin Güreli", label: "ulasilamadi" }, createdAt: ago(1) },
];
const templates = [
  ...
  { id: 6, name: "ulasilamadi", language: "tr", category: "UTILITY", status: "APPROVED", fill: ["agent"], components: [{ type: "BODY", text: "Örnek Şirket Teknik Uzmanınız {{1}} ben. Talebinize istinaden aradım, size ulaşamadım. Müsaitliğinizde buradan geri dönüş yapabilir misiniz?" }], updatedAt: ago(100) },
...
function answer(method: string, path: string, body: unknown): unknown {
  ...
  if (p === "/ratings") return {
    ...
    agents: [
      { agent: people[0], count: 71, average: 4.5, low: 3, questions: [{ question: "Temsilcimiz sorununuzu ne kadar hızlı çözdü?", count: 40, average: 4.7 }, { question: "Temsilcimizin ilgisinden memnun kaldınız mı?", count: 40, average: 4.6 }, { question: "Sorununuz tamamen çözüldü mü?", count: 40, average: 4.1 }, { question: "Tek soruluk anket", count: 31, average: 4.5 }] },
      { agent: people[1], count: 42, average: 3.9, low: 8, questions: [{ question: "Temsilcimiz sorununuzu ne kadar hızlı çözdü?", count: 25, average: 3.1 }, { question: "Temsilcimizin ilgisinden memnun kaldınız mı?", count: 25, average: 4.4 }, { question: "Sorununuz tamamen çözüldü mü?", count: 25, average: 4.0 }, { question: "Tek soruluk anket", count: 17, average: 4.1 }] },
